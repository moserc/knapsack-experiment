...
public class Main {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        times.add(FractionalKnapsack.Greedy.knapSack(knapsack30.getValues(), knapsack30.getWeights(), knapsack30.getMaxWeight(), knapsack30.getTotalItems(), knapsack30.getKnapsackNumber()));
        ...
        times.add(FractionalKnapsack.Dynamic.fractionalKnapsack(knapsack5.getValues(), knapsack5.getWeights(), knapsack5.getMaxWeight(), knapsack5.getKnapsackNumber()));
        times.add(FractionalKnapsack.Dynamic.fractionalKnapsack(knapsack10.getValues(), knapsack10.getWeights(), knapsack10.getMaxWeight(), knapsack10.getKnapsackNumber()));
        times.add(FractionalKnapsack.Dynamic.fractionalKnapsack(knapsack15.getValues(), knapsack15.getWeights(), knapsack15.getMaxWeight(), knapsack15.getKnapsackNumber()));
        times.add(FractionalKnapsack.Dynamic.fractionalKnapsack(knapsack20.getValues(), knapsack20.getWeights(), knapsack20.getMaxWeight(), knapsack20.getKnapsackNumber()));
        times.add(FractionalKnapsack.Dynamic.fractionalKnapsack(knapsack25.getValues(), knapsack25.getWeights(), knapsack25.getMaxWeight(), knapsack25.getKnapsackNumber()));
        times.add(FractionalKnapsack.Dynamic.fractionalKnapsack(knapsack30.getValues(), knapsack30.getWeights(), knapsack30.getMaxWeight(), knapsack30.getKnapsackNumber()));
